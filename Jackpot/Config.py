...
DEFAULT_PAR_CHANGEPOINT_THR = 2.0   # change point detector parameter: Z-Threshold
...
DEFAULT_PAR_CHANGEPOINT_NUM = 10.0     # change point detector parameter: lowest number of moving average samples that may trigger reset
